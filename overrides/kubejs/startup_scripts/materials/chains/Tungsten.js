StartupEvents.registry('gtceu:material', event => {
    ...
    event.create('gtceu:iron_hydroxide')
        ...
        .components('1x gtceu:iron', '2x gtceu:oxygen', '2x gtceu:hydrogen')
        .flags(GTMaterialFlags.DISABLE_DECOMPOSITION)
    event.create('gtceu:manganese_hydroxide')
        .dust()
        .color(0x6fb08e).iconSet(GTMaterialIconSet.BRIGHT)
        .components('1x gtceu:manganese', '2x gtceu:oxygen', '2x gtceu:hydrogen')
        .flags(GTMaterialFlags.DISABLE_DECOMPOSITION)
    event.create('gtceu:sodium_molybdenum_sulfide')
        .dust()
        .color(0x4c16a8).iconSet(GTMaterialIconSet.DULL)
        .components('2x gtceu:sodium', '1x gtceu:molybdenum', '4x gtceu:sulfur')
        .flags(GTMaterialFlags.DISABLE_DECOMPOSITION)
    event.create('gtceu:molybdenum_trisulfide')
        .dust()
        .color(0xC3B138).iconSet(GTMaterialIconSet.SHINY)
        .components('1x gtceu:molybdenum', '3x gtceu:sulfur')
        .flags(GTMaterialFlags.DISABLE_DECOMPOSITION)

    event.create('gtceu:lithium_hydroxide')
        .dust()
        .color(0xdde8e6).iconSet(GTMaterialIconSet.BRIGHT)
        .components('1x gtceu:lithium', '1x gtceu:oxygen', '1x gtceu:hydrogen')
        .flags(GTMaterialFlags.DISABLE_DECOMPOSITION)
    event.create('gtceu:manganese_ii_chloride')
        .liquid()
        .color(0xd6a3b2).iconSet(GTMaterialIconSet.DULL)
        .formula('MnCl2')
    ...
    event.create('gtceu:tungsten_trioxide')
        ...
        .components('1x gtceu:tungsten', '3x gtceu:oxygen')
        .flags(GTMaterialFlags.DISABLE_DECOMPOSITION)
