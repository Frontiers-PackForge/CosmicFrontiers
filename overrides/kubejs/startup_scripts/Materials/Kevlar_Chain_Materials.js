GTCEuStartupEvents.registry('gtceu:material', event => {
    ...
    event.create('crude_para_phenylenediamine')
        .liquid()
        .formula('C6H8N2')
