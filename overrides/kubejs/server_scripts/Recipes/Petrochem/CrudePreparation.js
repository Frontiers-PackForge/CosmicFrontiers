ServerEvents.recipes(event => {
    ...
    event.recipes.cosmiccore.desalter('frontiers:petrochem/salt_laden_light_oil_desalting')
        .inputFluids(['3200x cosmiccore:salt_laden_light_oil', '400x gtceu:distilled_water', '40x cosmiccore:polyethylene_oxide'])
        .outputFluids(['3000x gtceu:light_oil', '520x cosmiccore:sour_brine', '120x cosmiccore:oily_sludge'])
        .duration(20)
        .EUt(GTValues.V[GTValues.HV], 2)

    event.recipes.cosmiccore.desalter('frontiers:petrochem/salt_laden_oil_desalting')
        .inputFluids(['3200x cosmiccore:salt_laden_oil', '600x gtceu:distilled_water', '40x cosmiccore:polyethylene_oxide'])
        .outputFluids(['3000x gtceu:oil', '700x cosmiccore:sour_brine', '140x cosmiccore:oily_sludge'])
        .duration(30)
        .EUt(GTValues.V[GTValues.HV], 2)

    event.recipes.cosmiccore.desalter('frontiers:petrochem/salt_laden_heavy_oil_desalting')
        .inputFluids(['3200x cosmiccore:salt_laden_heavy_oil', '800x gtceu:distilled_water', '40x cosmiccore:polyethylene_oxide'])
        .outputFluids(['3000x gtceu:heavy_oil', '800x cosmiccore:sour_brine', '240x cosmiccore:oily_sludge'])
        .duration(40)
        .EUt(GTValues.V[GTValues.HV], 2)
