...
ServerEvents.recipes(event => { 
  ...
  event.remove({ id: 'knavesneeds:forbidden_arcanus/deorum/glaive' })
  event.remove({ id: 'knavesneeds:betternether/cincinnasite_diamond/twinblade' })
  event.remove({ id: 'knavesneeds:forbidden_arcanus/deorum/rapier' })
  event.remove({ id: 'knavesneeds:forbidden_arcanus/deorum/warglaive' })
  event.remove({ id: 'knavesneeds:betternether/cincinnasite_diamond/longsword' })
  event.remove({ id: 'knavesneeds:betternether/cincinnasite_diamond/warglaive' })
  event.remove({ id: 'knavesneeds:betternether/cincinnasite_diamond/claymore' })
  event.remove({ id: 'knavesneeds:forbidden_arcanus/deorum/twinblade' })
  event.remove({ id: 'knavesneeds:forbidden_arcanus/deorum/longsword' })
  event.remove({ id: '' })
  event.remove({ id: '' })
  event.remove({ id: '' })
  event.remove({ id: '' })
