...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler(`frontiers:illumar_smart_lamp`)
            .itemInputs(['projectred_core:red_illumar', 'projectred_core:blue_illumar', 'projectred_core:green_illumar', '4x #forge:glass_panes/colorless', '2x gtceu:vacuum_tube'])
    ...
    colours.forEach(colour => {
        ...
        event.recipes.gtceu.mixer(`frontiers:${colour}_irrumar_mixing`)
            .itemInputs(['2x minecraft:glowstone_dust', `#forge:dyes/${colour}`])
        ...
        event.recipes.gtceu.assembler(`frontiers:${colour}_illumar_lamp`)
            .itemInputs([`4x projectred_core:${colour}_illumar`, '4x #forge:glass_panes/colorless', 'projectred_transmission:red_alloy_wire'])
        ...
        event.recipes.gtceu.assembler(`frontiers:${colour}_fixture_light`)
            .itemInputs([`4x projectred_core:${colour}_illumar`, '5x #forge:glass_panes/colorless', 'projectred_core:conductive_plate'])
        ...
        event.recipes.gtceu.assembler(`frontiers:${colour}_lantern`)
            .itemInputs([`4x projectred_core:${colour}_illumar`, '2x #forge:glass_panes/colorless', 'gtceu:red_alloy_rod'])
