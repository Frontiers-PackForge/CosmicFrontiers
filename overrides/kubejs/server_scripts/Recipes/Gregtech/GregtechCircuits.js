ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.circuit_assembler('enthelic_processor_hv_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', 'cosmiccore:spirit_runed_enthel_cpu', '16x gtceu:smd_resistor', '8x gtceu:smd_capacitor', '8x gtceu:smd_transistor', '8x gtceu:fine_neptunium_wire'])
        .inputFluids('gtceu:tin 144')
    ...
    event.recipes.gtceu.circuit_assembler('enthelic_processor_assembly_ev_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', '2x cosmiccore:enthelic_processor', '8x gtceu:smd_inductor', '8x gtceu:smd_capacitor', '16x gtceu:ram_chip', '16x gtceu:fine_neptunium_wire'])
        .inputFluids('gtceu:tin 288')
    ...
    event.recipes.gtceu.circuit_assembler('enthelic_computer_iv_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', '4x cosmiccore:enthelic_processor_assembly', '8x gtceu:smd_diode', '4x gtceu:nor_memory_chip', '32x gtceu:ram_chip', '16x gtceu:fine_plutonium_wire'])
        .inputFluids('gtceu:tin 288')
