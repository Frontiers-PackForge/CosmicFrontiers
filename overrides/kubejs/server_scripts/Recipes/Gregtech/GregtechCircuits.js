ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.circuit_assembler('processor_mv_soldering_alloy')
        .itemInputs(['cosmiccore:runewoven_plastic_circuit_board', 'cosmiccore:runic_hex_cpu', '4x gtceu:smd_resistor', '4x gtceu:smd_transistor', '4x gtceu:smd_capacitor', '4x gtceu:fine_red_alloy_wire'])
        .inputFluids('gtceu:soldering_alloy 72')
        .itemOutputs('2x cosmiccore:hex_processor')
        .duration(200)
    ...
    event.recipes.gtceu.circuit_assembler('processor_assembly_hv_frontiers')
        .itemInputs(['cosmiccore:runewoven_plastic_circuit_board', '2x cosmiccore:hex_processor', '4x gtceu:smd_inductor', '8x gtceu:smd_capacitor', '4x gtceu:ram_chip', '4x gtceu:fine_red_alloy_wire'])
        .inputFluids('gtceu:tin 288')
        .itemOutputs('cosmiccore:hex_processor_assembly')
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)
        .EUt(GTValues.VA[GTValues.MV]);
    ...
    event.recipes.gtceu.circuit_assembler('workstation_ev_frontiers')
        .itemInputs(['cosmiccore:runewoven_plastic_circuit_board', '4x cosmiccore:hex_processor_assembly', '4x gtceu:smd_diode', '4x gtceu:ram_chip', '16x gtceu:fine_electrum_wire', '16x gtceu:terrasteel_bolt'])
        .inputFluids('gtceu:tin 288')
        .itemOutputs('cosmiccore:hex_processor_supercomputer')
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)
        .EUt(GTValues.VA[GTValues.MV]);
    ...
    event.recipes.gtceu.circuit_assembler('mainframe_iv_frontiers')
        .itemInputs(['2x gtceu:galvanized_ethersteel_frame', '6x cosmiccore:hex_processor_supercomputer', '8x gtceu:smd_inductor', '16x gtceu:smd_capacitor', '16x gtceu:ram_chip', '16x gtceu:soul_stained_steel_single_wire'])
        .inputFluids('gtceu:tin 576')
        .itemOutputs('cosmiccore:hex_processor_mainframe')
        .duration(800)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    event.recipes.gtceu.circuit_assembler('enthelic_processor_hv_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', 'cosmiccore:spirit_runed_enthel_cpu', '16x gtceu:smd_resistor', '8x gtceu:smd_capacitor', '8x gtceu:smd_transistor', '8x cosmiccore:fine_melodic_alloy_wire'])
        .inputFluids('gtceu:tin 144')
        .itemOutputs('2x cosmiccore:enthelic_processor')
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)
        .EUt(GTValues.VA[GTValues.EV]);
    event.recipes.gtceu.circuit_assembler('enthelic_processor_hv_soldering_alloy_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', 'cosmiccore:spirit_runed_enthel_cpu', '16x gtceu:smd_resistor', '8x gtceu:smd_capacitor', '8x gtceu:smd_transistor', '8x cosmiccore:fine_melodic_alloy_wire'])
        .inputFluids('gtceu:soldering_alloy 72')
        .itemOutputs('2x cosmiccore:enthelic_processor')
        .duration(200)
    ...
    event.recipes.gtceu.circuit_assembler('enthelic_processor_assembly_ev_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', '2x cosmiccore:enthelic_processor', '8x gtceu:smd_inductor', '8x gtceu:smd_capacitor', '16x gtceu:ram_chip', '16x cosmiccore:fine_melodic_alloy_wire'])
        .inputFluids('gtceu:tin 288')
        .itemOutputs('cosmiccore:enthelic_processor_assembly')
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)
        .EUt(GTValues.VA[GTValues.EV]);
    event.recipes.gtceu.circuit_assembler('enthelic_processor_assembly_ev_soldering_alloy_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', '2x cosmiccore:enthelic_processor', '8x gtceu:smd_inductor', '8x gtceu:smd_capacitor', '16x gtceu:ram_chip', '16x cosmiccore:fine_melodic_alloy_wire'])
        .inputFluids('gtceu:soldering_alloy 144')
        .itemOutputs('cosmiccore:enthelic_processor_assembly')
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)
        .EUt(GTValues.VA[GTValues.EV]);
    //enthelic SuperComputer changes
    ...
    event.recipes.gtceu.circuit_assembler('enthelic_computer_iv_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', '4x cosmiccore:enthelic_processor_assembly', '8x gtceu:smd_diode', '4x gtceu:nor_memory_chip', '32x gtceu:ram_chip', '16x cosmiccore:fine_signalum_wire'])
        .inputFluids('gtceu:tin 288')
        .itemOutputs('cosmiccore:enthelic_processor_supercomputer')
        .duration(200)
        .cleanroom(CleanroomType.CLEANROOM)
        .EUt(GTValues.VA[GTValues.EV]);
    event.recipes.gtceu.circuit_assembler('enthelic_computer_iv_soldering_alloy_frontiers')
        .itemInputs(['cosmiccore:spirit_engraved_enthel_circuit_board', '4x cosmiccore:enthelic_processor_assembly', '8x gtceu:smd_diode', '4x gtceu:nor_memory_chip', '32x gtceu:ram_chip', '16x cosmiccore:fine_signalum_wire'])
        .inputFluids('gtceu:soldering_alloy 144')
        .itemOutputs('cosmiccore:enthelic_processor_supercomputer')
        .duration(200)
    ...
    event.recipes.gtceu.circuit_assembler('enthelic_mainframe_luv_frontiers')
        .itemInputs(['2x gtceu:terrasteel_frame', '6x cosmiccore:enthelic_processor_supercomputer', '16x gtceu:smd_inductor', '32x gtceu:smd_capacitor', '64x gtceu:ram_chip', '32x gtceu:galvanized_ethersteel_single_wire'])
        .inputFluids('gtceu:tin 576')
        .itemOutputs('cosmiccore:enthelic_processor_mainframe')
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)
        .EUt(GTValues.VA[GTValues.EV]);
    event.recipes.gtceu.circuit_assembler('enthelic_mainframe_luv_soldering_alloy_frontiers')
        .itemInputs(['2x gtceu:terrasteel_frame', '6x cosmiccore:enthelic_processor_supercomputer', '16x gtceu:smd_inductor', '32x gtceu:smd_capacitor', '64x gtceu:ram_chip', '32x gtceu:galvanized_ethersteel_single_wire'])
        .inputFluids('gtceu:soldering_alloy 288')
        .itemOutputs('cosmiccore:enthelic_processor_mainframe')
        .duration(400)
    ...
    //Wetware Processor & Wetware SOC Processor
    event.recipes.gtceu.circuit_assembler('wetware_good_recipe')
        .itemInputs(['gtceu:neuro_processing_unit', 'cosmiccore:neuro_processing_assembly', '2x gtceu:stem_cells', 'gtceu:copper_plasmites'])
        .inputFluids('gtceu:high_grade_solder 576')
    ...
    event.recipes.gtceu.circuit_assembler('wetware_assembly_recipe')
        .itemInputs(['gtceu:wetware_printed_circuit_board', '2x gtceu:wetware_processor', '16x gtceu:advanced_smd_inductor', '32x gtceu:advanced_smd_capacitor', '24x cosmiccore:aram_chip', '16x cosmiccore:fine_neutronite_wire'])
        .inputFluids('gtceu:high_grade_solder 1152')
    ...
    event.recipes.gtceu.assembly_line('wetware_computer')
        .itemInputs(['4x gtceu:wetware_processor_assembly', '32x cosmiccore:aram_chip', '64x gtceu:nor_memory_chip', '64x gtceu:nand_memory_chip', '32x gtceu:hpic_chip', '64x gtceu:fine_rhenium_wire', '64x gtceu:fine_rhenium_wire', '16x gtceu:advanced_smd_inductor', '32x gtceu:advanced_smd_capacitor', '16x gtceu:advanced_smd_diode'])
