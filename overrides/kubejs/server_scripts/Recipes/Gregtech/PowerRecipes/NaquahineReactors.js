ServerEvents.recipes(event => {
    event.recipes.gtceu.naquahine_reactor('naquahine_mk_one')
        ...
        .inputFluids('gtceu:naquahine_superfuel_mk_one 24000')
        .duration(1200)
        .EUt(-GTValues.V[GTValues.UV])
    event.recipes.gtceu.naquahine_reactor('naquahine_mk_two')
        .itemInputs('64x gtceu:industrial_tnt')
        .magnetStats(50000, 450, true)
        .inputFluids('gtceu:naquahine_superfuel_mk_two 24000')
        .duration(1200)
    ...
    event.recipes.gtceu.distillation_tower('inert_naquahine')
        ...
        .itemInputs('4x bloodmagic:reagentteleposition')
        .outputFluids('gtceu:energized_naquahine_fuel_preperation 12000')
        .duration(120)
        .EUt(GTValues.VA[GTValues.LuV])
        ...
        .outputFluids('gtceu:aerated_naquahine 6000')
        .duration(160)
        .EUt(GTValues.VA[GTValues.LuV])
