...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.essence_reactor('elementium_what')
        .itemInputs(['cosmiccore:somnolent_dew', 'cosmiccore:pyretic_ichor', 'cosmiccore:ether_wisp', 'cosmiccore:verdant_anima', '8x botania:terrasteel_ingot'])
    ...
    event.recipes.gtceu.essence_reactor('dragonstone_what')
        .itemInputs(['cosmiccore:somnolent_dew', 'cosmiccore:pyretic_ichor', 'cosmiccore:ether_wisp', 'cosmiccore:verdant_anima', '8x botania:mana_diamond'])
        .inputFluids('gtceu:potent_mana 8000')
        .inputFluids('gtceu:source_oils 4000')
    ...
    event.recipes.gtceu.essence_reactor('pixedust_what')
        .itemInputs(['cosmiccore:somnolent_dew', 'cosmiccore:pyretic_ichor', 'cosmiccore:ether_wisp', 'cosmiccore:verdant_anima', '8x botania:mana_pearl'])
        .inputFluids('gtceu:potent_mana 8000')
        .inputFluids('gtceu:source_oils 4000')
    ...
    event.recipes.gtceu.essence_reactor('binding_reagent')
        .itemInputs(['16x cosmiccore:somnolent_dew', '16x cosmiccore:pyretic_ichor', '16x cosmiccore:ether_wisp', '16x cosmiccore:verdant_anima', '8x gtceu:berkelium_block', '4x gtceu:osmiridium_dust'])
        .inputFluids('gtceu:potent_mana 32000')
        .inputFluids('gtceu:source_oils 16000')
        .itemOutputs('4x cosmiccore:tethering_resin')
