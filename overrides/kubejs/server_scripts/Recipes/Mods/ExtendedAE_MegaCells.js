...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('frontiers:extendedae/matrix/frame')
    ...
    event.recipes.gtceu.assembler('frontiers:extendedae/matrix/wall')
    ...
    event.recipes.gtceu.assembler('frontiers:extendedae/matrix/pattern_unit')
    ...
    event.recipes.gtceu.assembler('frontiers:extendedae/matrix/crafting_unit')
        .itemInputs('4x gtceu:plascrete', 'ae2:cell_component_16k', '#gtceu:circuits/ev')
        .itemOutputs('extendedae:assembler_matrix_crafter')
        .duration(350)
        .EUt(GTValues.VA[GTValues.EV])

    event.recipes.gtceu.assembler('frontiers:extendedae/matrix/speed_unit')
    ...
    event.recipes.gtceu.assembler('frontiers:extendedae/matrix/glass')
    ...
    event.recipes.gtceu.assembler('frontiers:megacells/storage/item_cell_housing')
    ...
    event.recipes.gtceu.assembler('frontiers:megacells/storage/fluid_cell_housing')
    ...
    frontiersMegaCellTiers.forEach(tier => {
        ...
        event.recipes.gtceu.assembler(`frontiers:megacells/storage/cell_component_${tier.size}`)
