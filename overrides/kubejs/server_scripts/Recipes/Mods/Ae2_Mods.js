...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.polarizer('frontiers:ae2/materials/charged_certus_quartz')
        .itemInputs('gtceu:certus_quartz_gem')
        .itemOutputs('ae2:charged_certus_quartz_crystal')
        .duration(80)
        .EUt(GTValues.VA[GTValues.MV])

    event.recipes.gtceu.mixer('frontiers:ae2/materials/fluix_dust')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/materials/semi_dark_monitor')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/materials/formation_core')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/materials/annihilation_core')
    ...
    cableTiers.forEach(tier => {
        ...
        event.recipes.gtceu.cutter(`frontiers:ae2/cable_anchors/${tier.name}`)
    ...
    event.recipes.gtceu.lathe('frontiers:ae2/materials/quartz_fiber')
        .itemInputs('minecraft:quartz')
        .itemOutputs('ae2:quartz_fiber')
        .duration(20)
        .EUt(GTValues.VA[GTValues.LV])

    event.recipes.gtceu.assembler('frontiers:ae2/network/drive')
        .itemInputs('8x gtceu:steel_plate', '4x ae2:fluix_smart_cable', '2x #gtceu:circuits/lv', 'gtceu:steel_frame')
        .itemOutputs('ae2:drive')
        .duration(160)
        .EUt(GTValues.VA[GTValues.LV])

    event.recipes.gtceu.assembler('frontiers:ae2/network/terminal')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/network/export_bus')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/network/level_emitter')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/network/energy_level_emitter')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/network/me_p2p_tunnel')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/network/formation_plane')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/cards/basic')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/cards/advanced')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/storage/item_cell_housing')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/storage/fluid_cell_housing')
    ...
    storageTiers.forEach(tier => {
        event.recipes.gtceu.assembler(`frontiers:ae2/storage/cell_component_${tier.size}`)
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/storage/energy_cell')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/storage/dense_energy_cell')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/quantum/singularity')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/crafting/crafting_unit')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/crafting/molecular_assembler')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/crafting/blank_pattern_hv')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/crafting/pattern_encoding_terminal')
    ...
    event.recipes.gtceu.assembler('frontiers:ae2/crafting/pattern_access_terminal')
