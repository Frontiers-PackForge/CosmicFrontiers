...
ServerEvents.recipes(event => {
    event.shaped('8x create:fluid_pipe', [' A ', 'BCB', ' A '], { A: 'gtceu:bronze_plate', B: 'gtceu:red_alloy_foil', C: 'gtceu:bronze_ingot' })
    event.shaped('legendarysurvivaloverhaul:ice_fern_seeds', [' A ', 'ABA', ' A '], { A: 'gtceu:lapis_dust', B: 'minecraft:wheat_seeds' })
    event.shaped('legendarysurvivaloverhaul:sun_fern_seeds', [' A ', 'ABA', ' A '], { A: 'minecraft:redstone', B: 'minecraft:wheat_seeds' })
    ...
    event.recipes.gtceu.compressor('frontiers:hardened_resin')
    ...
    temperatureFernTypes.forEach(fern => {
        ...
        event.recipes.gtceu.macerator(`frontiers:${fern}_fern_seeds`)
            .itemInputs(leaf)
            .itemOutputs(seeds)
            .EUt(2, 1)
            .duration(50)
    ...
    event.recipes.gtceu.mixer('frontiers:fireclay_ball')
        ...
        .EUt(GTValues.V[GTValues.LV], 1)
        .duration(100)
    event.recipes.gtceu.compressor('frontiers:firebrick')
    ...
    event.recipes.cosmiccore.dawn_forge()
        .itemInputs('embers:archaic_circuit', 'embers:ember_crystal_cluster', 'embers:archaic_brick')
        .itemOutputs('embers:eldritch_insignia')
        .input('cosmiccore:ember', 250)
        .EUt(16, 1)
        .duration(100)
    event.recipes.gtceu.alloy_smelter('frontiers:dawnstone_ingot')
    ...
    event.recipes.gtceu.assembler('frontiers:steel_firebox_casing')
    ...
    event.recipes.gtceu.fluid_solidifier('frontiers:dawnstone_aspectus')
        .itemInputs('embers:ember_shard')
        .itemOutputs('embers:dawnstone_aspectus')
        .inputFluids('144x embers:molten_dawnstone')
        .duration(100)
        .EUt(GTValues.V[GTValues.LV], 2)
    //TODO: Cosmiccore: Needt to figure out why ember hatches won't fully fill, most likely a < used rather than a <=
    event.recipes.cosmiccore.dawn_forge()
        ...
        .input('cosmiccore:ember', 650)
        .EUt(GTValues.V[GTValues.LV], 8)
        .duration(350)
    event.recipes.gtceu.compressor('frontiers:ember_crystal_cluster')
    ...
    event.recipes.gtceu.mixer('frontiers:chalk_white_impure')
    ...
    event.recipes.gtceu.alloy_smelter('frontiers:bronze_ingot/copper_ingot_tin_dust')
        .itemInputs('3x minecraft:copper_ingot', 'gtceu:tin_dust')
        .itemOutputs('4x gtceu:bronze_ingot')
        .duration(80)
        .EUt(GTValues.V[GTValues.LV], 1)
    event.recipes.gtceu.alloy_smelter('frontiers:bronze_ingot/copper_dust_tin_ingot')
        .itemInputs('3x gtceu:copper_dust', 'gtceu:tin_ingot')
        .itemOutputs('4x gtceu:bronze_ingot')
        .duration(80)
        .EUt(GTValues.V[GTValues.LV], 1)
    event.recipes.gtceu.alloy_smelter('frontiers:bronze_ingot/copper_ingot_tin_ingot')
        .itemInputs('3x minecraft:copper_ingot', 'gtceu:tin_ingot')
        .itemOutputs('4x gtceu:bronze_ingot')
        .duration(80)
        .EUt(GTValues.V[GTValues.LV], 1)
    event.recipes.gtceu.alloy_smelter('frontiers:bronze_ingot/copper_dust_tin_dust')
        .itemInputs('3x gtceu:copper_dust', 'gtceu:tin_dust')
        .itemOutputs('4x gtceu:bronze_ingot')
        .duration(80)
        .EUt(GTValues.V[GTValues.LV], 1)
    event.recipes.gtceu.alloy_smelter('frontiers:bronze_ingot/annealed_copper_ingot_tin_dust')
        .itemInputs('3x gtceu:annealed_copper_ingot', 'gtceu:tin_dust')
        .itemOutputs('4x gtceu:bronze_ingot')
        .duration(80)
        .EUt(GTValues.V[GTValues.LV], 1)
    event.recipes.gtceu.alloy_smelter('frontiers:bronze_ingot/annealed_copper_dust_tin_ingot')
        .itemInputs('3x gtceu:annealed_copper_dust', 'gtceu:tin_ingot')
        .itemOutputs('4x gtceu:bronze_ingot')
        .duration(80)
        .EUt(GTValues.V[GTValues.LV], 1)
    event.recipes.gtceu.alloy_smelter('frontiers:bronze_ingot/annealed_copper_ingot_tin_ingot')
        .itemInputs('3x gtceu:annealed_copper_ingot', 'gtceu:tin_ingot')
        .itemOutputs('4x gtceu:bronze_ingot')
        .duration(80)
        .EUt(GTValues.V[GTValues.LV], 1)
    event.recipes.gtceu.alloy_smelter('frontiers:bronze_ingot/annealed_copper_dust_tin_dust')
    ...
    event.recipes.cosmiccore.industrial_primitive_blast_furnace()
        ...
        .inputFluids('125x embers:dwarven_oil')
        .duration(1000)
    event.recipes.gtceu.assembler('frontiers:seal_shards')
    ...
    event.recipes.gtceu.alloy_smelter('frontiers:cinderwax_ingot')
    ...
    event.recipes.gtceu.bender('frontiers:resin_circuit_board')
    ...
    event.recipes.gtceu.assembler('frontiers:resin_printed_circuit_board')
    ...
    event.recipes.gtceu.assembler('frontiers:resistor/tempered_iesnium')
    ...
    event.recipes.gtceu.extractor('frontiers:soulresin')
    ...
    event.recipes.gtceu.coke_oven('frontiers:arcane_charcoal/from_soulwood')
        ...
        .duration(900)
    event.recipes.gtceu.coke_oven('frontiers:arcane_charcoal/from_runewood')
        .itemInputs('#malum:runewood_logs')
        .itemOutputs('malum:arcane_charcoal')
        .outputFluids('250x embers:dwarven_oil')
        .duration(900)
    event.recipes.gtceu.coke_oven('frontiers:arcane_charcoal/from_otherworld_log')
        .itemInputs('occultism:otherworld_log')
        .itemOutputs('malum:arcane_charcoal')
        .outputFluids('250x embers:dwarven_oil')
        .duration(900)
    event.recipes.gtceu.coke_oven('frontiers:charcoal/from_woodstuff')
        .itemInputs('#frontiers:ordinary_coke_oven_logs')
        .itemOutputs('minecraft:charcoal')
        .outputFluids('250x gtceu:creosote')
        .duration(900)
    event.recipes.gtceu.assembler('frontiers:cogwork_units')
    ...
    event.recipes.gtceu.compressor('frontiers:treated_wood_plate')
    ...
    event.recipes.gtceu.mixer('frontiers:gold_sulfide_amalgam_dust')
    ...
    event.recipes.gtceu.bender('frontiers:waxed_leather/with_honeycomb')
        .itemInputs('minecraft:honeycomb', 'minecraft:leather')
        .itemOutputs('cosmiccore:waxed_leather')
        .EUt(16, 1)
        .duration(100)
    event.recipes.gtceu.bender('frontiers:waxed_leather/with_creosote_grease')
    ...
    event.recipes.gtceu.forge_hammer('frontiers:redstone')
        .itemInputs('cosmiccore:raw_redstona')
        .itemOutputs('8x minecraft:redstone')
        .EUt(16, 1)
        .duration(100)
    event.recipes.gtceu.forge_hammer('frontiers:lapis_lazuli')
        .itemInputs('cosmiccore:raw_lazuric')
        .itemOutputs('8x minecraft:lapis_lazuli')
        .EUt(16, 1)
        .duration(100)

    event.recipes.gtceu.forge_hammer('frontiers:coal')
        .itemInputs('cosmiccore:raw_carbonic')
        .itemOutputs('8x minecraft:coal')
        .EUt(16, 1)
        .duration(100)
    event.recipes.gtceu.forge_hammer('frontiers:salt_gem')
