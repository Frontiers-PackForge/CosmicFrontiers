ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.chemical_reactor('frontiers:blood_orb_weak')
        ...
        .duration(1400)
    event.recipes.gtceu.assembler('frontiers:lv_machine_casing')
        .itemInputs('cosmiccore:lv_cogwork_magicapacitor', 'cosmiccore:lv_modular_frameworks', '3x cosmiccore:lv_cladding')
    ...
    event.recipes.gtceu.sifter('frontiers:ember_grit/from_cinder_flour')
        ...
        .EUt(GTValues.V[GTValues.LV], 4)
        .duration(300)
    event.recipes.gtceu.assembler('frontiers:infinite_water_cover')
        .itemInputs('4x gtceu:lv_electric_pump', 'minecraft:cauldron', '4x #gtceu:circuits/lv')
    ...
    event.recipes.gtceu.assembler('frontiers:industrial_converter_shell')
        ...
        .EUt(GTValues.VA[GTValues.LV], 2)
        .duration(100)
    event.recipes.gtceu.distillery('frontiers:distilled_water')
        .inputFluids('4000x minecraft:water')
        .outputFluids('4000x gtceu:distilled_water')
        .circuit(1)
        .EUt(GTValues.VA[GTValues.LV], 1)
        .duration(100)
    event.recipes.gtceu.distillery('frontiers:ethanol/from_biomass_bad')
        .inputFluids('1000x gtceu:biomass')
        .outputFluids('600x gtceu:ethanol')
        .circuit(1)
        .EUt(GTValues.VA[GTValues.LV], 2)
        .duration(100)
    event.recipes.gtceu.canner('frontiers:dynamite')
        .itemInputs('4x cosmiccore:cannon_powder', 'create:cardboard')
        .itemOutputs('4x gtceu:dynamite')
        .inputFluids('25x embers:dwarven_oil')
        .EUt(GTValues.VA[GTValues.LV], 1)
        .duration(100)
    event.recipes.gtceu.centrifuge('frontiers:nitrogen/from_air_centri')
        ...
        .EUt(GTValues.V[GTValues.LV], 2)
        .duration(400)
    event.recipes.gtceu.centrifuge('frontiers:water/from_biomass_bad')
        .inputFluids('1000x gtceu:biomass')
        .outputFluids('300x minecraft:water')
        .circuit(2)
        .EUt(GTValues.V[GTValues.LV], 2)
        .duration(400)
    event.recipes.gtceu.electric_blast_furnace('frontiers:energetic_aluminium_ingot/without_nitrogen')
    ...
    event.recipes.gtceu.electric_blast_furnace('frontiers:energetic_aluminium_ingot/with_nitrogen')
        .itemInputs('cosmiccore:energetic_aluminium_dust')
        .inputFluids('250x gtceu:nitrogen')
        .itemOutputs('cosmiccore:energetic_aluminium_ingot')
        .circuit(2)
        .blastFurnaceTemp(1700)
        .duration(400)
        .EUt(GTValues.V[GTValues.MV], 1)
    event.recipes.cosmiccore.chemical_dehydrator('frontiers:rotting_essence')
        .itemInputs('minecraft:rotten_flesh')
        .itemOutputs('malum:rotting_essence')
        .inputFluids('100x gtceu:hydrochloric_acid')
        .EUt(GTValues.VA[GTValues.LV], 2)
        .duration(600)
    event.recipes.gtceu.chemical_bath('frontiers:salt_water')
        .itemInputs('cosmiccore:driftweed')
        .inputFluids('1000x minecraft:water')
    ...
    event.recipes.cosmiccore.spooling_machine()
        ...
        .EUt(GTValues.V[GTValues.LV], 1)
        .duration(100)
    event.recipes.gtceu.distillery('frontiers:ethanol/from_biomass')
