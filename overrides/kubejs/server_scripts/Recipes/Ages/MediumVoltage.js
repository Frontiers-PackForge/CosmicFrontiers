ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler()
        .itemInputs('4x gtceu:galvanized_ethersteel_plate', '2x gtceu:terrasteel_foil', '2x #gtceu:circuits/mv', 'cosmiccore:polarized_bathyst_electret')
    ...
    event.recipes.gtceu.forming_press('frontiers:chains/bathyst_electret/blank_forming')
    ...
    event.recipes.gtceu.chemical_bath('frontiers:chains/nyctophyte_exchange/media_functionalization')
    ...
    event.recipes.gtceu.chemical_bath('frontiers:chains/nyctophyte_exchange/media_regeneration')
