ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('frontiers:mv_machine_casing')
        ...
        .duration(100)
    event.recipes.gtceu.assembler('frontiers:empty_tier_0_capacitor')
        .itemInputs('gtceu:dark_steel_frame', '6x gtceu:dark_steel_plate', '24x gtceu:dark_steel_screw')
        .itemOutputs('cosmiccore:empty_tier_0_capacitor')
        .EUt(GTValues.VA[GTValues.LV], 4)
        .duration(100)
    event.recipes.cosmiccore.spooling_machine('frontiers:medium_voltage_stator_housing')
        .itemInputs('4x gtceu:mv_voltage_coil', '16x gtceu:electrum_double_wire')
        .itemOutputs('cosmiccore:medium_voltage_stator_housing')
        .EUt(GTValues.VA[GTValues.LV], 1)
        .duration(100)
    event.recipes.gtceu.canner('frontiers:lv_capacitor_battery')
        .itemInputs('cosmiccore:empty_tier_0_capacitor', '16x #gtceu:batteries/lv')
        .itemOutputs('cosmiccore:lv_capacitor_battery')
        .EUt(GTValues.VA[GTValues.MV], 1)
        .duration(100)
    event.recipes.gtceu.canner('frontiers:mv_capacitor_battery')
        .itemInputs('cosmiccore:empty_tier_0_capacitor', '16x #gtceu:batteries/mv')
        .itemOutputs('cosmiccore:mv_capacitor_battery')
        .EUt(GTValues.VA[GTValues.MV], 1)
        .duration(100)
    event.recipes.gtceu.canner('frontiers:hv_capacitor_battery')
        .itemInputs('cosmiccore:empty_tier_0_capacitor', '16x #gtceu:batteries/hv')
        .itemOutputs('cosmiccore:hv_capacitor_battery')
        .EUt(GTValues.VA[GTValues.MV], 1)
        .duration(100)
    event.shaped('cosmiccore:capacitor_array', ['ABA', 'ABA', 'CDC'], { A: '#gtceu:circuits/mv', B: 'cosmiccore:empty_tier_0_capacitor', C: 'gtceu:lv_transformer_16a', D: 'cosmiccore:somarust_casing' })
    event.recipes.gtceu.assembler('frontiers:lv_machine_hull')
        ...
        .duration(100)
    event.recipes.gtceu.fermenter('frontiers:multi_phase_oil')
        .itemInputs('64x cosmiccore:cannon_powder')
        .inputFluids('8000x minecraft:water')
        .outputFluids('8000x gtceu:multi_phase_oil')
        .EUt(GTValues.VA[GTValues.MV], 4)
        .duration(400)
    event.recipes.gtceu.fermenter('frontiers:salt_water')
    ...
    event.recipes.cosmiccore.biomana_digestor()
        ...
        .EUt(GTValues.V[GTValues.MV], 1)
        .duration(1200)
    event.recipes.gtceu.chemical_reactor('frontiers:rain_sealant')
        .inputFluids('500x gtceu:soulresin', '250x gtceu:cinderwax', '250x gtceu:polyethylene')
        .outputFluids('1000x cosmiccore:rain_sealant')
        .EUt(GTValues.V[GTValues.MV], 1)
        .duration(200)
    event.recipes.gtceu.canner('frontiers:rain_sealant_spray_can')
        .itemInputs('gtceu:empty_spray_can')
        .inputFluids('1000x cosmiccore:rain_sealant')
        .itemOutputs('cosmiccore:rain_sealant_spray_can')
        .EUt(GTValues.V[GTValues.LV], 1)
        .duration(100)
    event.recipes.gtceu.fluid_solidifier('frontiers:refractory_structural_casing')
        .itemInputs('gtceu:firebricks')
        .itemOutputs('cosmiccore:refractory_structural_casing')
        .inputFluids('16x gtceu:stainless_steel')
        .EUt(GTValues.VA[GTValues.MV], 6)
        .duration(100)
    event.recipes.gtceu.assembler('frontiers:vibrant_pipe_framework')
        .itemInputs('cosmiccore:energetic_aluminium_frame', '3x gtceu:polyvinyl_chloride_plate', '3x gtceu:steel_plate')
        .itemOutputs('cosmiccore:vibrant_pipe_framework')
        .circuit(6)
        .EUt(GTValues.VA[GTValues.LV], 2)
        .duration(100)
    event.recipes.gtceu.mixer('frontiers:bloom_rich_algae_solution/from_algaes')
        .itemInputs('16x cosmiccore:green_algae', '16x cosmiccore:red_algae', '16x cosmiccore:blue_algae')
        .inputFluids('1000x gtceu:distilled_water')
        .outputFluids('1000x cosmiccore:bloom_rich_algae_solution')
        .EUt(GTValues.VA[GTValues.MV], 4)
        .duration(400)
    event.recipes.cosmiccore.sculk_biochamber('frontiers:bloomwyrm_algae')
        .itemInputs('cosmiccore:blue_proto_algae', 'cosmiccore:green_proto_algae', 'cosmiccore:red_proto_algae', '4x gtceu:iron_dust')
        .itemOutputs('64x cosmiccore:bloomwyrm_algae')
        .biopowerInput(4)
        .maxCampusParallel(16)
        .EUt(GTValues.VA[GTValues.MV], 4)
    ...
    event.shaped('4x cosmiccore:mv_cogwork_magicapacitor', ['ABA', 'CDC', 'ABA'], { A: 'cosmiccore:nostium_plate', B: 'neovitae:tabula_rasa', C: 'cosmiccore:energetic_aluminium_foil', D: '#gtceu:circuits/lv' })
    ...
    event.recipes.gtceu.assembler('frontiers:hv_cogwork_magicapacitor')
        .itemInputs('4x cosmiccore:galvanized_ethersteel_plate', '2x gtceu:sterling_silver_foil', '#gtceu:circuits/mv', '2x cosmiccore:polarized_bathyst_electret')
        .itemOutputs('4x cosmiccore:hv_cogwork_magicapacitor')
        .EUt(GTValues.V[GTValues.MV], 1)
        .duration(100)
