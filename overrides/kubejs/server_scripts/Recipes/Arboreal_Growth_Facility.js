ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.arboreal_growth_facility(`menril_growth_solution`)
     ...
     event.recipes.gtceu.arboreal_growth_facility(`runewood_nether_sediment`)
    ...
    event.recipes.gtceu.arboreal_growth_facility(`runewood_growth_solution`)
        .notConsumable(`1x malum:runewood_sapling`)
        .notConsumable(`1x minecraft:dirt`)
        .inputFluids(['gtceu:nutrient_solution 10', 'gtceu:air 100'])
    ...
    event.recipes.gtceu.arboreal_growth_facility(`soulwood_nether_sediment`)
    ...
    event.recipes.gtceu.arboreal_growth_facility(`soulwood_growth_solution`)
        .notConsumable(`1x malum:soulwood_growth`)
        .notConsumable(`1x malum:blighted_soil`)
        .inputFluids(['gtceu:nutrient_solution 10', 'gtceu:air 100'])
