...
yeet('metalbarrels:wood_to_crystal')
yeet('metalbarrels:copper_to_crystal')
yeet('metalbarrels:iron_to_crystal')
yeet('metalbarrels:silver_to_crystal')
yeet('metalbarrels:gold_to_crystal')
yeet('metalbarrels:diamond_to_crystal')
yeet('metalbarrels:wood_to_obsidian')
yeet('metalbarrels:silver_to_diamond')
yeet('metalbarrels:wood_to_netherite')
yeet('metalbarrels:wood_to_diamond')
yeet('metalbarrels:crystal_barrel')
yeet('metalbarrels:iron_to_gold')
yeet('metalbarrels:copper_to_obsidian')
yeet('metalbarrels:copper_to_silver')
yeet('metalbarrels:iron_to_diamond')
yeet('metalbarrels:silver_to_obsidian')
yeet('metalbarrels:copper_to_netherite')
yeet('metalbarrels:gold_to_obsidian')
yeet('metalbarrels:wood_to_gold')
yeet('metalbarrels:gold_to_netherite')
yeet('metalbarrels:iron_to_obsidian')
yeet('metalbarrels:wood_to_silver')
yeet('metalbarrels:iron_to_netherite')
yeet('metalbarrels:wood_to_iron')
yeet('metalbarrels:copper_to_gold')
...
ServerEvents.recipes(event => {
    ...
    event.remove({ id: 'embers:mixing/dwarven_oil' })
    event.remove({ id: 'embers:mixing/dwarven_oil_steam' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_cinnabar_water' })
    ...
    event.remove({ id: 'gtceu:electric_blast_furnace/blast_energetic_aluminium_gas' })
    event.remove({ id: 'gtceu:electric_blast_furnace/blast_energetic_aluminium' })
    ...
    event.remove({ id: 'occultism:spirit_fire/spirit_attuned_gem' })
    event.remove({ id: 'occultism:crafting/chalk_purple_impure' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_fluix_water' })
    event.remove({ id: 'gtceu:autoclave/silicon_dioxide_to_quartzite_gem' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_quartzite_water' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_certus_quartz_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_lapis_water' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_fluix_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_monazite_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_sodalite_water' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_apatite_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_quartzite_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_lazurite_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_apatite_water' })
    event.remove({ id: 'gtceu: autoclave/ autoclave_dust_cinnabar_water' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_nether_quartz_water' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_lapis_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_cinnabar_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_certus_quartz_water' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_sodalite_distilled' })
    event.remove({ id: 'gtceu:autoclave/autoclave_dust_nether_quartz_distilled' })
