...
ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.hellfire_foundry('zpm_soul_input')
    .itemInputs(['gtceu:zpm_machine_hull', '16x kubejs:resplendent_sylvan_nanolattice',  '16x bloodmagic:demonslate', 'gtceu:stainless_steel_fluid_cell', 'gtceu:zpm_sensor'])
    .inputFluids('gtceu:grading_fluid_1 500')
  ...
  event.recipes.gtceu.hellfire_foundry('zpm_soul_output')
    .itemInputs(['gtceu:zpm_machine_hull', '16x kubejs:resplendent_sylvan_nanolattice', '16x bloodmagic:etherealslate', 'gtceu:stainless_steel_fluid_cell', 'gtceu:zpm_emitter'])
    .inputFluids('gtceu:grading_fluid_4 500')
  ...
  */
  ...
  event.recipes.gtceu.hemophagic_transfuser('blade_mechanical')
    ...
    .soulInput(CosmicSoulTypes.Refined, 2000)
    .duration(320)
    .EUt(GTValues.VA[GTValues.LuV]);
