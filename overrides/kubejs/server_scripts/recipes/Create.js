...
ServerEvents.tags('item', event => {
  ...
  //Other Modded Plate Removals From the c Tag - Remember to Hide in EMI if needed below
  ...
  //Other Modded ingot Removals From the c Tag
  event.remove('c:ingots/zinc', 'create:zinc_ingot')
  event.remove('c:ingots/brass', 'create:brass_ingot')
  event.remove('c:nuggets/zinc', 'create:zinc_nugget')
  event.remove('c:nuggets/brass', 'create:brass_nugget')
...
ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.rock_breaker(`create:${CSreg}_rock_breaker`)
    .notConsumableItem(`create:${CSreg}`)
  ...
  event.recipes.gtceu.rock_breaker(`create:${CSchoc}_rock_breaker`)
    .notConsumableItem(`create:${CSchoc}`)
  ...
  event.recipes.gtceu.rock_breaker(`create:${CShoney}_rock_breaker`)
    .notConsumableItem(`create:${CShoney}`)
  ...
  event.recipes.gtceu.rock_breaker(`create:tuff_rock_breaker`)
    .notConsumableItem(`minecraft:tuff`)
  ...
  event.recipes.gtceu.rock_breaker(`create:calcite_rock_breaker`)
    .notConsumableItem(`minecraft:calcite`)
  ...
  event.recipes.gtceu.rock_breaker(`create:dripstone_block_rock_breaker`)
    .notConsumableItem(`minecraft:dripstone_block`)
    ...
    event.recipes.create.crushing([CreateProcessingOutput.of('minecraft:clay_ball', 0.10)], 'minecraft:dripstone_block').processingTime(10)
    event.recipes.create.milling([CreateProcessingOutput.of('minecraft:clay_ball', 0.05)], 'minecraft:dripstone_block').processingTime(15)
  ...
  event.recipes.gtceu.sifter("frontiers:sifting_cinder_flour")
    ...
    .chancedOutput('create:cinder_flour', 3500, 0)
    .chancedOutput('create:cinder_flour', 2500, 0)
    .chancedOutput('create:cinder_flour', 1000, 0)
    .duration(50)
    .EUt(16);
  //shaft
  ...
  event.recipes.gtceu.extruder("create:shaft")
    ...
    .notConsumableItem('gtceu:normal_pipe_extruder_mold')
    .itemOutputs('12x create:shaft')
    .duration(50)
    .EUt(GTValues.VA[GTValues.MV]);
  //Andesite Casing
  event.recipes.gtceu.assembler("create:andesite_casing")
    .itemInputs('1x #c:stripped_logs', 'gtceu:andesite_alloy_plate')
  ...
  event.recipes.gtceu.assembler("create:brass_casing")
    .itemInputs('1x #c:stripped_logs', 'gtceu:brass_plate')
  ...
  event.recipes.gtceu.assembler("create:copper_casing")
    .itemInputs('1x #c:stripped_logs', 'gtceu:copper_plate')
  ...
  event.recipes.gtceu.assembler("create:millstone")
    .itemInputs('2x gtceu:andesite_alloy_gear', 'create:cogwheel', 'create:andesite_casing', '2x #c:stone', 'ulvcovm:ulv_electric_motor')
  ...
  event.recipes.gtceu.assembler("create:rope_pulley")
    .itemInputs('3x gtceu:andesite_alloy_plate', '2x create:andesite_casing', '2x create:shaft', 'ulvcovm:ulv_electric_motor', '#c:ropes')
  ...
  event.recipes.gtceu.assembler("create:elevator_pulley")
    .itemInputs('3x gtceu:andesite_alloy_plate', '2x create:brass_casing', '2x create:shaft', 'ulvcovm:ulv_electric_motor', '#c:rope')
  ...
  event.recipes.gtceu.assembler("create:sticker")
    .itemInputs('2x gtceu:andesite_alloy_plate', '2x gtceu:stone_plate', '#c:slimeballs', 'gtceu:red_alloy_bolt')
  ...
  event.recipes.gtceu.mixer("create:rose_quartz")
    .itemInputs('#c:gems/rose_quartz')
    .notConsumableItem('minecraft:sand')
  ...
  event.recipes.gtceu.forge_hammer("create:rose_quartz")
    ...
    .duration(100)
    .EUt(24);
  event.recipes.gtceu.compressor("biomesoplenty:rose_quartz_compressing")
    .itemInputs('4x biomesoplenty:rose_quartz_chunk')
    .itemOutputs('biomesoplenty:rose_quartz_block')
    .duration(300)
    .EUt(2);
  event.recipes.gtceu.compressor("create:rose_quartz_block_compressing")
...
//    .EUt(8);
  ...
  event.recipes.gtceu.assembler("create_hypertube:hypertube")
    .itemInputs('2x gtceu:double_brass_plate', '8x #c:glass_panes')
...
ServerEvents.recipes(event => {
  event.recipes.create.filling('gtceu:treated_wood_planks', [Fluid.of("gtceu:creosote", 125), Ingredient.of("#minecraft:planks")])
