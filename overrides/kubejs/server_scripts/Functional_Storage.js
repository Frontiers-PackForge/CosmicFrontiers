let yeet = (itemName) => {
  ...
  ServerEvents.tags('item', event => {
    console.log('[10] - [1] - TAG-WATCHER')
      ...
      event.remove('c:tools/hammers', itemName)
  })
}
...
ServerEvents.recipes( e => {
  ...
  e.recipes.gtceu.assembler('copper_upgrade_assembly')
    .itemInputs(['5x gtceu:double_copper_plate', '2x #c:chests', '#functionalstorage:drawer'])
  ...
  e.recipes.gtceu.assembler('gold_upgrade_assembly')
    ...
    e.recipes.gtceu.assembler('functionalstorage:diamond_upgrade') 
           ...
           .itemInputs('minecraft:diamond_block') //temp replace cause no botania
  ...
  e.recipes.gtceu.assembler('void_upgrade_assembly')
    .itemInputs(['4x gtceu:obsidian_plate', '3x #c:ender_pearls', '#functionalstorage:drawer'])
