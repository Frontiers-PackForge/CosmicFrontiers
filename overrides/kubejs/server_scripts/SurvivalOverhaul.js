...
ServerEvents.recipes(event => {
    ...
    event.shaped( 'legendarysurvivaloverhaul:cooling_coat_2', [
        ...
        P: 'gtceu:steel_rod', //change back to soul stained
    ...
    event.shaped( 'legendarysurvivaloverhaul:cooling_coat_3', [
        ...
        D: 'minecraft:paper', //change back to terraweave cloth
    ...
    event.shaped( 'legendarysurvivaloverhaul:thermal_coat_2', [
        ...
        D: 'gtceu:steel_rod', //change back to soul stained
   ...
   //sewing table 
    ...
    //these are brokey till cosmiccore is fixed
